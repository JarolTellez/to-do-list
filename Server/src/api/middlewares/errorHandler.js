...
/**
 * Global error handling middleware for API layer
 * @middleware errorHandler
 * @description Centralized error handling for all API routes with proper error transformation and logging
 */
