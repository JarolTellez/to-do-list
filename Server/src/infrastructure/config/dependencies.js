...
} = require("../../aplication/dtos/request_dto/taskRequestDTOs");
const {
  CreateSessionRequestDTO,
  RefreshSessionRequestDTO,
} = require("../../aplication/dtos/request_dto/sessionRequestDTOs");
...
} = require("../../aplication/dtos/response_dto/taskResponseDTOs");
...
const taskTagMapper = new TaskTagMapper({
  TaskTag,
  tagMapper,
  TaskTagResponseDTO,
  TaskTagRequestDTO,
...
const userTagMapperWithBind = {
  ...
  dbToDomainWithRelations:
    userTagMapper.dbToDomainWithRelations.bind(userTagMapper),
};
